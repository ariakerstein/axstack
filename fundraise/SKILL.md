...
Track feedback from investor conversations to identify patterns and prioritize deck improvements.

### Storage

Feedback is stored locally in `.axestack/feedback.json` in the project root:

```json
{
  "deck": "pitch-deck-v2.html",
  "feedback": [
    {
      "id": "f1",
      "quote": "GTM was unclear, how do you actually acquire customers?",
      "investor": "Partner @ Sequoia",
      "date": "2025-03-25",
      "themes": ["gtm", "clarity"],
      "sentiment": "concern"
    }
...
```
/fundraise feedback add "Your traction feels early for this stage"
/fundraise feedback add "Love the team, but GTM is hand-wavy" --investor "Jane @ a]6z"
```

When adding feedback, Claude will:
1. Extract the quote
2. Auto-detect themes (maps to scoring categories)
3. Assign sentiment: `praise`, `concern`, `question`, `pass`
4. Save to `.axestack/feedback.json`

### Theme Detection

Map investor language to deck scoring categories:

| Keywords | Theme | Maps To |
|----------|-------|---------|
| "unclear", "confusing", "don't understand" | clarity | Premise: Clarity |
| "why now", "timing", "market" | timing | Premise: Non-consensus |
| "team", "experience", "founder" | team | Premise: Believability |
| "traction", "users", "revenue", "early" | traction | Content: Traction |
| "GTM", "acquire", "customers", "CAC", "channel" | gtm | Content: GTM Clarity |
| "business model", "monetize", "pricing" | model | Content: Business Model |
| "competition", "differentiation", "moat" | competition | Content: Competition |
| "ask", "use of funds", "milestones" | ask | Content: The Ask |
| "slides", "design", "fonts", "busy" | design | Structure: Visual |

### Feedback Analysis Output

When running `/fundraise feedback analyze`:

```
## FEEDBACK ANALYSIS

**Total conversations:** 5
**Date range:** Mar 15 - Mar 25, 2025

---

### Theme Frequency

| Theme | Count | % | Deck Score | Gap? |
|-------|-------|---|------------|------|
| GTM Clarity | 3 | 60% | 2/3 | ⚠️ YES |
| Traction | 2 | 40% | 2/3 | ⚠️ YES |
| Team | 3 | 60% | 3/3 | No |
| Clarity | 1 | 20% | 3/3 | No |
...
| Sentiment | Count | Quotes |
|-----------|-------|--------|
| Concern | 4 | "GTM unclear...", "Traction early..." |
| Praise | 3 | "Love the team...", "Clear problem..." |
| Question | 2 | "How do you acquire...", "What's the moat?" |
| Pass | 1 | "Not our thesis" |

---

### TOP PRIORITY FIXES

Based on feedback patterns vs deck scores:

1. **GTM Clarity (60% flagged, 2/3 score)**
   - 3 investors mentioned this
   - Add specific channel + CAC data
   - Show customer acquisition funnel

2. **Traction (40% flagged, 2/3 score)**
   - Add timeframes to all metrics
   - Show growth velocity, not just totals

---

### WHAT'S WORKING

- **Team** — 3 investors praised, 3/3 score
- **Problem clarity** — No concerns raised

---

### RAW FEEDBACK LOG

| Date | Investor | Quote | Theme | Sentiment |
|------|----------|-------|-------|-----------|
| 3/25 | Partner @ Sequoia | "GTM was unclear..." | gtm | concern |
| 3/24 | Jane @ a16z | "Love the team..." | team | praise |
| ... | ... | ... | ... | ... |
```

### Comparing Feedback to Deck Review

When you run `/fundraise review` after logging feedback, the output will include:

```
## FEEDBACK CORRELATION

| Category | Score | Investor Feedback |
|----------|-------|-------------------|
| GTM Clarity | 2/3 | ⚠️ 3 investors flagged this |
| Traction | 2/3 | ⚠️ 2 investors flagged this |
| Team | 3/3 | ✅ Praised by 3 investors |
```

This helps validate: are the scores aligned with real investor reactions?

### Workflow

1. **Before meetings**: `/fundraise review deck.html` — know your weak spots
2. **After each meeting**: `/fundraise feedback add "..."` — log reactions
3. **After 3-5 meetings**: `/fundraise feedback analyze` — find patterns
4. **Iterate deck**: Fix top patterns, re-review
5. **Track progress**: Compare feedback before/after changes
